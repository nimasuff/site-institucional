    ...
    <section id="contato">
        <form action="#" method="POST" id="form-contato">
            ...
            <div class="linha-form">
                ...
                <input type="text" name="c-nome" id="c-nome" class="formatacao-input" placeholder="seu nome" maxlength="30">
            </div>
            <!-- <div class="linha-form">
            ...
            <div class="linha-form">
                ...
                <input type="email" name="c-email" id="c-email" class="formatacao-input" placeholder="seu e-mail" maxlength="40">
            </div>
            <div class="comentario-form">
                <label for="comentario">Comentário</label>
                <textarea name="comentario" id="comentario" cols="15" rows="5" placeholder="seu comentário deve ter até 144 caracteres" maxlength="144"></textarea>
            </div>
